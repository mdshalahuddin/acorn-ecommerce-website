                    ...
                    <ul class="search-cart-wrapper d-flex">
                        ...
                        <li>
                            ...
                            <ul class="cart-wrap dropdown_style">
                                <li class="cart-items">
                                    <div class="cart-img">
                                        <img src="{{ asset('assets/frontend/assets') }}/images/cart/1.jpg"
                                            alt="">
                                    </div>
                                ...
                                <li class="cart-items">
                                    <div class="cart-img">
                                        <img src="{{ asset('assets/frontend/assets') }}/images/cart/3.jpg"
                                            alt="">
                                    </div>
                                    <div class="cart-content">
                                        <a href="cart.html">Pure Nature Product</a>
                        ...
                        <li>
                            ...
                            <ul class="cart-wrap dropdown_style">
                                ...
                                <li class="cart-items">
                                    <div class="cart-img">
                                        <img src="{{ asset('assets/frontend/assets') }}/images/cart/2.jpg"
                                            alt="">
                                    </div>
                                    <div class="cart-content">
                                        <a href="cart.html">Pure Nature Product</a>
